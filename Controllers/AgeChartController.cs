        ...
        public IActionResult DownloadReport()
        {
            ...
            if (numRows > 0) //We have data
            {
                ...
                using (ExcelPackage excel = new ExcelPackage())
                {
                    ...
                    var workSheet = excel.Workbook.Worksheets.Add("Age Report");

                    workSheet.Cells[3, 1].Value = "Range of Age";
                    workSheet.Cells[3, 2].Value = "No. of Member";

                    workSheet.Cells[4, 1].Value = "0-12";
                    workSheet.Cells[4, 2].Value = mInc1;

                    workSheet.Cells[5, 1].Value = "13-18";
                    workSheet.Cells[5, 2].Value = mInc2;

                    workSheet.Cells[6, 1].Value = "19-64";
                    workSheet.Cells[6, 2].Value = mInc3;

                    workSheet.Cells[7, 1].Value = "65+";
                    workSheet.Cells[7, 2].Value = mInc4;


                    workSheet.Cells[8, 1].Value = "Total";
                    workSheet.Cells[8, 2].Value = mInc6;
                    ...
                    workSheet.Cells[1, 1].Value = "Member's report by Age";
                    ...
                    if (syncIOFeature != null)
                    {
                        ...
                        using (var memoryStream = new MemoryStream())
                        {
                            ...
                            Response.Headers["content-disposition"] = "attachment;  filename=Member Age Report.xlsx";
                    ...
                    else
                    {
                        try
                        {
                            ...
                            string filename = "Member Age Report.xlsx";
